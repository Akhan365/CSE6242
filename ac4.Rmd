---
title: 'AC4: Visualize Geolocated Data'
subtitle: |-
...
```
*Data section* 
This section contains detailed steps to load airports, routes, airlines data from http://openflights.org . In order to save TA's time final preprocessed dataframe attached to this assignmnet (USAirports.csv).
...
```
*Analysis section*
Using the preprocced data frame, sort the airports descendingly by number of routes passing through. Then plot the top 10 airports over a map of USA.
```{r analysis}
